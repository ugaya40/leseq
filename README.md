...
<!-- 
I actually don't know how to flex with this results
## Benchmarks

```
✓ tests/comparsion.bench.ts (10) 51275ms
✓ array methods vs leseq 10000 (2) 31025ms
name hz min max mean p75 p99 p995 p999 rme samples
· leseq 52.7977 16.7708 29.3660 18.9402 19.6550 27.4766 28.2653 29.3660 ±1.42% 264 fastest
· array methods 35.9895 24.0719 42.9678 27.7859 29.6318 35.4962 42.9678 42.9678 ±1.51% 181
✓ array methods vs leseq 1000 (2) 36055ms
name hz min max mean p75 p99 p995 p999 rme samples
· leseq 607.51 1.3166 3.6759 1.6461 1.7964 2.8037 3.0095 3.1974 ±0.81% 3038 fastest
· array methods 485.41 1.6858 4.2689 2.0601 2.2390 3.3290 3.4958 3.8926 ±0.75% 2428
✓ array methods vs leseq 100 (2) 41072ms
name hz min max mean p75 p99 p995 p999 rme samples
· leseq 5,850.88 0.1342 4.4450 0.1709 0.1509 0.6452 0.7505 0.9498 ±0.60% 29256 fastest
· array methods 5,187.58 0.1652 1.0312 0.1928 0.1851 0.4757 0.5240 0.6624 ±0.33% 25939
✓ array methods vs leseq 50 (2) 46106ms
name hz min max mean p75 p99 p995 p999 rme samples
· leseq 11,102.80 0.0700 3.7360 0.0901 0.0796 0.2838 0.6364 0.8687 ±0.59% 55514 fastest
· array methods 10,222.39 0.0842 1.0158 0.0978 0.0932 0.2349 0.2865 0.4242 ±0.27% 51113
✓ array methods vs leseq 10 (2) 51263ms
name hz min max mean p75 p99 p995 p999 rme samples
· leseq 38,859.59 0.0194 7.0239 0.0257 0.0226 0.0641 0.0939 0.9416 ±0.88% 194299
· array methods 48,218.84 0.0175 1.8829 0.0207 0.0196 0.0527 0.0637 0.1349 ±0.21% 241095 fastest

BENCH Summary

leseq - tests/comparsion.bench.ts > array methods vs leseq 10000
1.47x faster than array methods

leseq - tests/comparsion.bench.ts > array methods vs leseq 1000
1.25x faster than array methods

leseq - tests/comparsion.bench.ts > array methods vs leseq 100
1.13x faster than array methods

leseq - tests/comparsion.bench.ts > array methods vs leseq 50
1.09x faster than array methods

array methods - tests/comparsion.bench.ts > array methods vs leseq 10
1.24x faster than leseq
``` -->
